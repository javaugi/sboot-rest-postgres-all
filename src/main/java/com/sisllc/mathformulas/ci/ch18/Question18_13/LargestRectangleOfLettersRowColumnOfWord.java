package com.sisllc.mathformulas.ci.ch18.Question18_13;

import com.sisllc.mathformulas.ci.lib.AssortedMethods;
import com.sisllc.mathformulas.ci.lib.Trie;
import java.util.ArrayList;

public class LargestRectangleOfLettersRowColumnOfWord {

    private int maxWordLength;
    private WordGroup[] groupList;
    private Trie trieList[];

    public LargestRectangleOfLettersRowColumnOfWord(String[] list) {
