...
import com.sisllc.mathformulas.ci.lib.TreeNode;

public class Q45CreateBST2 {
    ...
    public static boolean checkBSTAlternate(TreeNode n) {
        return checkBSTAlternate(n, new D45IntWrapper(0), new D45IntWrapper(0));
    }

    public static boolean checkBSTAlternate(TreeNode n, D45IntWrapper min, D45IntWrapper max) {
        /* An alternate, less clean approach. This is not provided in the book, but is used to test the other method. */
        if (n.left == null) {
            min.data = n.data;
        } else {
            D45IntWrapper leftMin = new D45IntWrapper(0);
            D45IntWrapper leftMax = new D45IntWrapper(0);
        ...
        if (n.right == null) {
            ...
            D45IntWrapper rightMin = new D45IntWrapper(0);
            D45IntWrapper rightMax = new D45IntWrapper(0);
