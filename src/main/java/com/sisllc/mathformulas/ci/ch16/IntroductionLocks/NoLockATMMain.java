package com.sisllc.mathformulas.ci.ch16.IntroductionLocks;

public class NoLockATMMain {

    public static void main(String[] args) {
        NoLockATM noLockATM = new NoLockATM();
        LockedATM lockedATM = new LockedATM();
        AtmThread thread1 = new AtmThread(noLockATM, lockedATM);
        AtmThread thread2 = new AtmThread(noLockATM, lockedATM);
