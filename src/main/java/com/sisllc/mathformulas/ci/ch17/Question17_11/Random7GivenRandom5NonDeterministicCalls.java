package com.sisllc.mathformulas.ci.ch17.Question17_11;

public class Random7GivenRandom5NonDeterministicCalls {
    ...
    public static int rand7() {
        while (true) {
            ...
            int r2 = rand5();
            /* will be later used to generate a 0 or 1 */
            if (r2 != 4) {
                /* r2 has an extra even number, so discard the extra */
                int rand1 = r2 % 2;
                /* Generate 0 or 1 */
                int num = r1 + rand1;
                /* will be in the range 0 through 9 */
                if (num < 7) {
                    return num;
                }
            }
