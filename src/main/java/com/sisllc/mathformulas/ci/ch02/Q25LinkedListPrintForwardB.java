 ...
 * $LastChangedBy
 */
public class Q25LinkedListPrintForwardB {
    ...
    private static Q25PartialSum addListsHelper(LinkedListNode l1, LinkedListNode l2) {
        if (l1 == null && l2 == null) {
            Q25PartialSum sum = new Q25PartialSum();
            return sum;
        }
        Q25PartialSum sum = addListsHelper(l1.next, l2.next);
    ...
    private static LinkedListNode addLists(LinkedListNode l1, LinkedListNode l2) {
        ...
        Q25PartialSum sum = addListsHelper(l1, l2);
        if (sum.carry == 0) {
            return sum.sum;
        } else {
